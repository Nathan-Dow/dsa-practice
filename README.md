...
My accepted LeetCode solutions, synced automatically by [`sync_leetcode.py`](sync_leetcode.py). Folders are each problem's primary topic tag.

| # | Problem | Difficulty | Tags | Solution |
|--:|---------|------------|------|----------|
| 1 | [Two Sum](https://leetcode.com/problems/two-sum/) | Easy | Array, Hash Table | [two-sum.py](array/two-sum.py) |
...
| 202 | [Happy Number](https://leetcode.com/problems/happy-number/) | Easy | Hash Table, Math, Two Pointers, Floyd's Cycle Finding Algorithm | [happy-number.py](hash-table/happy-number.py) |
...
| 219 | [Contains Duplicate II](https://leetcode.com/problems/contains-duplicate-ii/) | Easy | Array, Hash Table, Sliding Window | [contains-duplicate-ii.py](array/contains-duplicate-ii.py) |
...
| 242 | [Valid Anagram](https://leetcode.com/problems/valid-anagram/) | Easy | Hash Table, String, Sorting | [valid-anagram.py](hash-table/valid-anagram.py) |
| 274 | [H-Index](https://leetcode.com/problems/h-index/) | Medium | Array, Sorting, Counting Sort | [h-index.py](array/h-index.py) |
| 290 | [Word Pattern](https://leetcode.com/problems/word-pattern/) | Easy | Hash Table, String | [word-pattern.py](hash-table/word-pattern.py) |
